...
| 133 | explain the top 5 augmentation ablations that had the best effect |
| 134 | wwhy dont we have an A2? |
| 135 | do we have qualitative visuals of our model working |
| 136 | do we have qualitative visuals of our model working |
| 137 | add visual that will show the predicted trajectory predictions overlays along with the ground truth |
| 138 | add a legend to the figure |
| 139 | what model(s) was used while generating the codebase for this project |
| 140 | Is every artifact generated by Cursor properly documented and cited showcasing that the artifact was generated by AI, as aligns with the Generative AI Use Po... |
| 141 | I want you to implement all changes to ensure ALL use of generative AI is explicitly documented including plans, prompts, transcripts, and documentation mark... |
| 142 | provide a list of all libraries and other sources that need cited as per this references policy:  This section should include citations for: (1) Any papers m... |
| 143 | the forecast_qualitative.png overlay has lots of multicolored lines that do not match the legend. |
| 144 | I dont see the linear baseline predictions. are the orange lines just under the ground-truth? |
| 145 | create a table/chart with all 15 geometry free rule features for my to include in the Methods section |
