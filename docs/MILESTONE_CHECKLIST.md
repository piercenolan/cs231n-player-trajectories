...
| 16 | **Cross-sequence transfer (3 clips)** | Done | `multiseq_transfer_baseline.csv` |
| 17 | **Per-clip LSTM retrain (3 new clips)** | Done | `multiseq_perclip_summary.csv`; `c001` beats linear |
